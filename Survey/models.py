...
class Question(models.Model):
    ...
    __original_answers = None

    def __init__(self, *args, **kwargs):
        super(Question, self).__init__(*args, **kwargs)
        self.__original_answers = [self.answer_1,self.answer_2,self.answer_3]

    def __str__(self):
        return self.question_text

    def save(self, *args, **kwargs):
        if (self.answer_1 != self.__original_answers[0] or self.answer_2 != self.__original_answers[1] or self.answer_3 != self.__original_answers[2]):
            self.votes_1 = 0
            self.votes_2 = 0
            self.votes_3 = 0
